...
export const ELEMENTS = {
  ...
  VI: {
    ...
    volatility: 0.9,
    difficulty_weight: 5,
    illegal_without_any_of: ["CS","EV","RE"], // Virality without any Stabilizer element → Collapse
    teaches: "scale_risk",
...
export const THESES = {
  ...
  VI_without_ST: {
    ...
    must_include: ["VI"],
    must_exclude: ["CS","EV","RE"],
    illegal_rule: { type: "missing_any_of", element: "VI", required_any_of: ["CS","EV","RE"], result: "COLLAPSE" },
    default_teaching: "risk_management"
  }
};
